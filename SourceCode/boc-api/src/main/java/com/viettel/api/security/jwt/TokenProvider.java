package com.viettel.api.security.jwt;
...
public class TokenProvider {
    ...
    public Authentication getAuthentication(String token) {
        ...
        UsernamePasswordAuthenticationToken userToken = new UsernamePasswordAuthenticationToken(principal, token, authorities);
        BocUserDto bocUserDto = new BocUserDto();
        try{
        	bocUserDto = gson.fromJson((String) claims.get(USER_KEY), BocUserDto.class);
        }catch(Exception ex) {
        	bocUserDto.setUserId(null);
        }
        userToken.setDetails(bocUserDto);
        return userToken;
    }
