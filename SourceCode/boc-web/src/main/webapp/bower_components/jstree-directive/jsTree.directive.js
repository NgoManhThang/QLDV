      ...
      if (a.treePlugins) {
        ...
        if (config.plugins.indexOf('search') >= 0) {
          ...
          if (e.next().attr('class') !== 'ng-tree-search') {
            e.after('<input type="text" placeholder="Tìm kiếm đơn vị" class="ng-tree-search"/>')
              .next()
