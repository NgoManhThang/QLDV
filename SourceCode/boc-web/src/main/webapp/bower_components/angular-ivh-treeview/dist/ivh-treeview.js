...
angular.module('ivh.treeview').directive('ivhTreeviewCheckboxHelper', [function() {
  ...
  return {
    ...
    '<label class="md-check">',
      '<input type="checkbox" class="ivh-treeview-checkbox" ng-model="isSelected" ng-click="resolveIndeterminateClick()" ng-change="trvw.select(node, isSelected)" />',
      '<i class="blue"></i>{{trvw.label(node)}}',
    '</label>'
    ].join('\n')
  };
}]);
  ...
  return {
    ...
    template: [
      '<span class="ivh-treeview-twistie">',
        '<i class="fa fa-plus-square-o ivh-treeview-twistie-collapsed"></i>',
        '<i class="fa fa-minus-square-o ivh-treeview-twistie-expanded"></i>',
      '</span>'
    ].join('\n'),
    link: function(scope, element, attrs, trvw) {
  ...
  var options = {
    ...
    nodeTpl: [
      '<div class="ivh-treeview-node-content" title="{{trvw.label(node)}}">',
        ...
        '</span>',
        '<span class="ivh-treeview-checkbox-wrapper" ng-if="trvw.useCheckboxes()" ivh-treeview-checkbox>',
        '</span>',
